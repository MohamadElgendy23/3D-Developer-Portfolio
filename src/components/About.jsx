...
const About = () => {
  return (
    <div className="bg-hero-pattern">
      ...
      programming and improving my skills. I am experienced in multiple popular
      languages and frameworks such as JavaScript, TypeScript, Java, C#,
      React.js, Node.js, and Three.js. I truly believe that with my skills and
      personality, I can mesh well with any team to build software that will
      last a lifetime!
    </div>
  );
};
